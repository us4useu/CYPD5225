...
/* Disable PD command support in HPI library. */
#define CCG_HPI_PD_CMD_DISABLE                      (1u)

/*******************************************************************************
 * PD Stack Configuration
 ******************************************************************************/

/* Disable PD Revision 3.0 support. */
#define CCG_PD_REV3_ENABLE                          (0u)

/* Disable Fast Role Swap from Sink to Source. */
...
#define APP_VBUS_SNK_FET_OFF_P2()                   pd_internal_cfet_off(1, 0)

#define APP_VBUS_SNK_FET_ON_P1()                    pd_internal_cfet_on(0, 0)
#define APP_VBUS_SNK_FET_ON_P2()                    pd_internal_cfet_on(1, 0)

/* Provider FET controls. */
#define APP_VBUS_SRC_FET_OFF_P1()                   pd_internal_pfet_off(0, 0)
#define APP_VBUS_SRC_FET_OFF_P2()                   pd_internal_pfet_off(1, 0)

#define APP_VBUS_SRC_FET_ON_P1()                    pd_internal_pfet_on(0, 0)
#define APP_VBUS_SRC_FET_ON_P2()                    pd_internal_pfet_on(1, 0)

/* Discharge path controls. */
#define APP_DISCHARGE_FET_OFF_P1()                  pd_internal_vbus_discharge_off(0)
#define APP_DISCHARGE_FET_OFF_P2()                  pd_internal_vbus_discharge_off(1)

#define APP_DISCHARGE_FET_ON_P1()                   pd_internal_vbus_discharge_on(0)
#define APP_DISCHARGE_FET_ON_P2()                   pd_internal_vbus_discharge_on(1)
...
#define APP_VBUS_SET_5V_P2()                        __asm("NOP\n")
#define APP_VBUS_SET_9V_P2()                        __asm("NOP\n")
#define APP_VBUS_SET_12V_P2()                       __asm("NOP\n")
#define APP_VBUS_SET_13V_P2()                       __asm("NOP\n")
#define APP_VBUS_SET_15V_P2()                       __asm("NOP\n")
#define APP_VBUS_SET_19V_P2()                       __asm("NOP\n")
#define APP_VBUS_SET_20V_P2()                       __asm("NOP\n")
...
/* Disable alternate mode support when device is DFP. */
#define DFP_ALT_MODE_SUPP                           (0u)

/* Disable DisplayPort source support. */
...
#define NCP81239_EN_P2()                             NCP81239_EN_P2_Write(1)

#define NCP81239_DIS_P1()                            NCP81239_EN_P1_Write(0)
#define NCP81239_DIS_P2()                            NCP81239_EN_P2_Write(0)

/* BC 1.2 Source support is disabled. */
#define BC_1_2_SRC_ENABLE                           (0u)

/* Enable deep sleep for power saving. */
#define SYS_DEEPSLEEP_ENABLE                        (1u)

/* Disable hardware based DRP toggle to reduce flash usage. */
#define CCG_HW_DRP_TOGGLE_ENABLE                    (0u)
