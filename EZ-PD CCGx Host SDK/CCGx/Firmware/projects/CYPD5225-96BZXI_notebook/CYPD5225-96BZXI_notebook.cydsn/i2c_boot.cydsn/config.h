...
#define DISABLE_I2C_ADDR_CONFIG             (0u)
 ...
 * Using SYSTICK timer to reduce code size.
 */
#define TIMER_TYPE                              (TIMER_TYPE_SYSTICK)

/*
 * Deep-sleep or optimized timer operation is not enabled in boot-loader.
 */
#define TIMER_TICKLESS_ENABLE                   (0)

/*
 * Timer module supports multiple software instances based on a single hardware
 * timer. Only one instance is required in the boot-loader project.
 */
